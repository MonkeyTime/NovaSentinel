...
const translations = {
  fr: {
    ...
    appSubtitle: "Déploiement de masse et licences Premium",
    language: "Langue",
    overview: "Accueil",
    ...
    cloudConnection: "Connexion Premium Cloud",
    ...
    organizationKey: "Clé Premium de masse",
    ...
    missingDeploymentConfig: "Renseignez l’URL cloud, la clé Premium et l’installateur.",
    noDestructiveAction: "Aucune action destructive n’est générée.",
    licenseOperations: "Licences de masse",
    licensePool: "Pool Premium",
  ...
  en: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "Mass deployment and Premium licensing",
    language: "Language",
    overview: "Home",
    ...
    missingDeploymentConfig: "Enter the cloud URL, Premium key, and installer.",
    noDestructiveAction: "No destructive action is generated.",
    licenseOperations: "Bulk licenses",
    licensePool: "Premium pool",
  ...
  es: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "Despliegue masivo y licencias Premium",
    language: "Idioma",
    overview: "Inicio",
    ...
    missingDeploymentConfig: "Introduce la URL cloud, la clave Premium y el instalador.",
  ...
  de: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "Massenbereitstellung und Premium-Lizenzen",
    language: "Sprache",
    overview: "Start",
    ...
    missingDeploymentConfig: "Cloud-URL, Premium-Schlüssel und Installer eingeben.",
  ...
  it: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "Distribuzione massiva e licenze Premium",
    language: "Lingua",
    overview: "Home",
    ...
    missingDeploymentConfig: "Inserisci URL cloud, chiave Premium e installer.",
  ...
  pt: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "Implantação em massa e licenças Premium",
    language: "Idioma",
    overview: "Início",
    ...
    missingDeploymentConfig: "Indique URL cloud, chave Premium e instalador.",
  ...
  ar: {
    appName: "NovaSentinel Admin Console",
    appSubtitle: "النشر الجماعي وتراخيص Premium",
    language: "اللغة",
    overview: "الرئيسية",
    deployment: "النشر",
    licenses: "التراخيص",
    ...
    missingDeploymentConfig: "أدخل رابط السحابة ومفتاح Premium والمثبت.",
    noDestructiveAction: "لا يتم إنشاء أي إجراء مدمر.",
    licenseOperations: "التراخيص الجماعية",
    licensePool: "مجموعة Premium",
